...
<body>
    <div class="container mt-5">
        <a href="{{ url('todo_show') }}"><button type="button" class="btn btn-custom btn-back mt-4 ms-5">Previous Page</button></a>
        
        <form class="mt-4" method="post" action="../todo_update/{{$todoArr->country_id}}">
            @csrf
            <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control" id="name" name="name" required value="{{$todoArr->name}}">
            </div>
            <div class="mb-3">
                <label for="mobile" class="form-label">Mobile</label>
                <input type="text" class="form-control" id="mobile" name="mobile" value="{{$todoArr->mobile}}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="age" name="age" value="{{$todoArr->age}}">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="location" name="location" value="{{$todoArr->location}}">
            </div>
            <button type="submit" class="btn btn-custom btn-submit mt-4 ms-5" name="submit">Update</button>
        </form>
    </div>
